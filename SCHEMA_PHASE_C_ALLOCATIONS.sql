...
--
-- The three tables checked for are the FINGERPRINT of the staffing
-- database, not the tables this file touches. `overtime` and `daily_hours`
-- are named because they exist nowhere else on the account, which is what
-- makes the check decisive.
-- =====================================================================
